...
def get_spotify_info(TIME=5):
    try:
        ...
        if len(item['album']['images']) > 0:
            ...
            if path.exists("@TheFastUserBot-Spotify.jpg"):
                remove("@TheFastUserBot-Spotify.jpg")          
            try:
                r = get(str(item['album']['images'][0]['url']))
                with open("@TheFastUserBot-Spotify.jpg", 'wb') as f:
                    f.write(r.content)    

                with open('@TheFastUserBot-Spotify.jpg', 'rb') as f:
